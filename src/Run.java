...
import players.custom_mcts.customMCTSParams;
import players.custom_mcts.customMCTSPlayer;
import players.rhea.RHEAPlayer;
import players.rhea.utils.Constants;
import players.rhea.utils.RHEAParams;
import players.custom_rhea.customRHEAPlayer;
import players.custom_rhea.utils.customConstants;
...
public class Run {
    ...
    private static void printHelp()
    {
        ...
        System.out.println("\t\t 6 CUSTOM_MCTS 300 iterations, length: 20");
    }
            ...
            for(int i = 4; i <= 7; ++i) {
                ...
                switch(agentType) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        customMCTSParams customParams = new customMCTSParams();
                        customParams.stop_type = customParams.STOP_ITERATIONS;
                        customParams.num_iterations = 300;
                        customParams.rollout_depth = 20;

                        //customParams.heuristic_method = customParams.CUSTOM_HEURISTIC;
                        p = new customMCTSPlayer(seed, playerID++, customParams);
