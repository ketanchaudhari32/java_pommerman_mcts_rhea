...
public class MCTSParams implements ParameterSet {
    ...
    public final int CUSTOM_ADVANCED_HEURISTIC = 2;
    ...
    public int heuristic_method = CUSTOM_ADVANCED_HEURISTIC;
    ...
    public Map<String, Object[]> getParameterValues() {
        ...
        parameterValues.put("heuristic_method", new Integer[]{CUSTOM_HEURISTIC, ADVANCED_HEURISTIC,CUSTOM_ADVANCED_HEURISTIC});
    ...
    public Map<String, String[]> constantNames() {
        ...
        names.put("heuristic_method", new String[]{"CUSTOM_HEURISTIC", "ADVANCED_HEURISTIC. CUSTOM_ADVANCED_HEURISTIC"});
        return names;
    }
}
