...
public class MCTSPlayerWithConK extends ParameterizedPlayer {
    ...
    public MCTSPlayerWithConK(long seed, int id) {
        this(seed, id, new MCTSParams());
    }

    public MCTSPlayerWithConK(long seed, int id, MCTSParams params) {
    ...
    @Override
    public Player copy() {
        return new MCTSPlayerWithConK(seed, playerID, params);
    }
}