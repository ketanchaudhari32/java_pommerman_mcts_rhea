...
public class MCTSPlayerWithBias extends ParameterizedPlayer {
    ...
    public MCTSPlayerWithBias(long seed, int id) {
        this(seed, id, new MCTSParams());
    }

    public MCTSPlayerWithBias(long seed, int id, MCTSParams params) {
    ...
    @Override
    public Player copy() {
        return new MCTSPlayerWithBias(seed, playerID, params);
    }
}