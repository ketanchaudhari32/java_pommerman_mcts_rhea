package players.custom_rhea.utils;
...
public abstract class customUtilities {
    ...
    public static customIndividual[] add_array_to_array(customIndividual[] first, customIndividual[] second, int skip) {
        int length1 = first.length;
        int length2 = second.length;
        customIndividual[] newArray = new customIndividual[length1 + length2 - skip];
    ...
    public static customIndividual[] deep_copy_pop(customIndividual[] population) {
        int popSize = population.length;
        customIndividual[] newPop = new customIndividual[popSize];
    ...
    public static void print_pop(customIndividual[] population) {
        System.out.println(Arrays.toString(population) + "\n");
    }

    public static int index_ind_in_pop(customIndividual i, customIndividual[] population) {
        int popSize = population.length;
