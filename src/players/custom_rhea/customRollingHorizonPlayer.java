...
import players.custom_rhea.evo.customEvolution;
...
class customRollingHorizonPlayer {
    private Random randomGenerator;
    private customRHEAParams params;
    private customGameInterface gameInterface;

    private int[] actionBuffer;
    private boolean newBuffer;

    private customEvolution ea;


    customRollingHorizonPlayer(Random randomGenerator, customRHEAParams params, customGameInterface gInterface) {
        ...
        newBuffer = true;
        ea = new customEvolution(params, randomGenerator, gameInterface);
    }
